define(function() {
   ...
   */
  "use strict";
  var divineLoadingMessage, loadingScreenPOS;
  ...
  return {
    start: function(POS) {
      var loadingScreen, selectedLoadingMessage;
    ...
    stop: function(POS) {
      return this.getLoadingScreen(POS).css("display", "none");
    },
    getLoadingScreen: function(POS) {
